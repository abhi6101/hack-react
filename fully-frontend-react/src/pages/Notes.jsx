            ...
            <Helmet>
                ...
                <div className="papers-header-container" style={{ marginBottom: '2rem' }}>
                    <div className="papers-header-left">
                        <h1 style={{ margin: 0, fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', fontWeight: '800', background: 'linear-gradient(90deg, #fff, var(--primary))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Study Notes</h1>
                    </div>
                </div>
                {loading ? (
