                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="hero-text-content" style={{ textAlign: 'left' }}>
                            ...
                            <div className="hero-ctas" style={{ marginTop: '2.5rem', display: 'flex', gap: '1rem', justifyContent: 'flex-start' }}>
                                ...
                                <Link to="/resume-builder" className="cta-btn secondary-btn" style={{ padding: '0.8rem 2rem', fontSize: '1rem', borderRadius: '12px', background: 'transparent', backdropFilter: 'blur(10px)', border: '1px solid #00d4ff', color: '#00d4ff', fontWeight: '600', textDecoration: 'none', transition: 'all 0.3s ease', textAlign: 'center' }} onMouseOver={(e) => { e.currentTarget.style.boxShadow = '0 0 15px rgba(0, 212, 255, 0.5)'; e.currentTarget.style.transform = 'translateY(-2px)'; }} onMouseOut={(e) => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.transform = 'translateY(0)'; }}>
                                    Build Resume
                                </Link>
                            </div>
