...
const Jobs = () => {
    ...
    const loadMockJobs = () => {
        const mockJobs = [
            { id: 1, title: 'Software Development Engineer', company_name: 'Google', description: 'Working on next-gen cloud infra and AI integration systems.', salary: 4500000, last_date: '2025-12-31' },
            { id: 2, title: 'Data Scientist', company_name: 'Microsoft', description: 'Utilizing machine learning to solve complex data problems and build predictive models.', salary: 3800000, last_date: '2025-11-15' },
            { id: 3, title: 'Full Stack Developer', company_name: 'Amazon', description: 'Design and implementation of highly scalable and available web services.', salary: 3200000, last_date: '2025-10-20' },
            { id: 4, title: 'Frontend Specialist', company_name: 'Netflix', description: 'Building the world-class streaming UI used by millions of users worldwide.', salary: 4200000, last_date: '2025-09-05' },
            { id: 5, title: 'DevOps Intern', company_name: 'TCS', description: 'Assisting in CI/CD pipeline optimization and cloud automation tasks.', salary: 500000, last_date: '2025-08-30' },
            { id: 6, title: 'Associate Engineer', company_name: 'Infosys', description: 'Junior role focusing on enterprise software development and maintenance.', salary: 450000, last_date: '2025-12-10' }
        ];
        setAllJobs(mockJobs);
        setLoading(false);
    };
