...
const HiddenSEO = () => (
    <div style={{
        ...
        <p>Students using Hack2Hired get access to a complete suite of career preparation and job application tools:</p>
        <ul>
        ...
        <h2>Features for Colleges and Recruiters</h2>
        <p>Colleges and recruiters benefit from powerful administrative and recruitment management tools:</p>
        <ul>
        ...
        <h2>Get Started with Hack2Hired Today</h2>
        <p>
